// CODE FROM https://github.com/suyashkumar/ssl-proxy
package main
...
var (
	...
	redirectHTTP = flag.String("redirectHTTP", "true", "if false, don't redirects http requests from port 80 to https at your fromURL")
)
...
func startWebServer() {
	...
	if strings.ToLower(*redirectHTTP) == "true" {
